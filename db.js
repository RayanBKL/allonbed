...
function initDb() {
  ...
  const countEnigmas = db.prepare('SELECT COUNT(*) as count FROM enigmas').get().count;
  if (countEnigmas === 0) {
    const insertEnigma = db.prepare(`
    ...
    const defaultNodes = [
      {
        node: 1,
        code: "DOSSIER #01",
        name: "Hugo V. (Trésorier)",
        role: "Gardien des Comptes",
        active: 1, // First active by default
        pass: "ALLIN",
        title: "La Transaction Suspecte",
        type: "text",
        ...
        hint: "Terme de poker pour miser l'intégralité de ses jetons (5 lettres).",
        media: "",
        x: 18, y: 22
      },
      {
        node: 2,
        code: "DOSSIER #02",
        name: "Léa M. (VP Communication)",
        role: "Stratège Réseaux",
        active: 0,
        pass: "ROYAL",
        title: "Interception Radio Fréquence 108.4",
        type: "cipher",
        content: "Enregistrement haché : 'Quinte d'As... La plus haute marche du podium de Vegas.'",
        hint: "La quinte suprême au poker (5 lettres).",
        media: "",
        x: 50, y: 14
      },
      {
        node: 3,
        code: "DOSSIER #03",
        name: "Théo B. (Pôle Soirées)",
        role: "Maître de la Nuit",
        active: 0,
        pass: "ROULETTE",
        title: "Le Jeton Brûlé au 36 Rouge",
        type: "text",
        content: "Un sous-verre taché de cocktail retrouvé au fond du club clandestin.",
        hint: "La grande roue des casinos (8 lettres).",
        media: "",
        x: 82, y: 22
      },
      {
        node: 4,
        code: "DOSSIER #04",
        name: "Camille D. (Secrétaire Générale)",
        role: "Archiviste Centrale",
        active: 0,
        pass: "BLACKJACK",
        title: "Le Chiffre Fatidique 21",
        type: "text",
        content: "Une carte de visite froissée : 'Ne dépassez jamais le compte de 21 face au croupier.'",
        hint: "Le célèbre jeu de cartes de table (9 lettres).",
        media: "",
        x: 88, y: 52
      },
      {
        node: 5,
        code: "DOSSIER #05",
        name: "Maxime R. (Pôle Partenariats)",
        role: "Négociateur de l'Ombre",
        active: 0,
        pass: "CASINO",
        title: "Le Contrat de la Suite Royale",
        type: "text",
        content: "Mallette biométrique retrouvée près de la terrasse du campus.",
        hint: "Le temple des jeux d'argent (6 lettres).",
        media: "",
        x: 80, y: 82
      },
      {
      ...
      },
      {
        node: 7,
        code: "DOSSIER #07",
        name: "Alexandre P. (Pôle Sport)",
        role: "Capitaine de Garde",
        active: 0,
        pass: "BLUFF",
        title: "L'Art du Trompe-l'Œil",
        type: "text",
        content: "Message vocal intercepté : 'Faire croire qu'on a le jeu parfait même les mains vides.'",
        hint: "Technique pour tromper ses adversaires (5 lettres).",
        media: "",
        x: 18, y: 82
      },
      {
        node: 8,
        code: "DOSSIER #08",
        name: "Sarah L. (Pôle Créa & Design)",
        role: "Directrice Artistique",
        active: 0,
        pass: "VEGAS",
        title: "La Cité du Désert",
        type: "text",
        content: "Billet d'avion factice à destination du Nevada avec le logo ALL ON BED.",
        hint: "La Mecque du casino (5 lettres).",
        media: "",
        x: 10, y: 52
      },
      {
        node: 9,
        code: "DOSSIER #09",
        name: "LE PRÉSIDENT (Otage Clé)",
        role: "Chef du BDE ALL ON BED",
        active: 0,
        pass: "ALLONBED",
        title: "L'Appel de Détresse Final",
        type: "text",
        ...
        hint: "Le nom de notre BDE (8 lettres).",
        media: "",
        x: 35, y: 35
      }
    ];
  ...
  // Master Puzzle 9-Letter Code: 'WEAREBACK' (Stored ONLY as salted Bcrypt hash!)
  const masterExists = db.prepare('SELECT id FROM master_puzzle WHERE id = 1').get();
  ...
  if (!masterExists) {
    ...
    // Update hash to ensure WEAREBACK is the active master password
    db.prepare(`
